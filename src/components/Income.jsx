        ...
        <div class="container">
          <div class="row">
            <div class="logo-wrapper">
              <a href=".">
                <img src="/static/media/logo.46a0b122f586f8f63c5a.png" alt="" />
              </a>
            </div>
          </div>
        </div>
              ...
              <div class="question-wrapper">
                <div class="question-item">
                  <div class="question">
                    ...
                    <Link to="/medicare-medicaid">Yes</Link>
                    <Link to="/medicare-medicaid">No</Link>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="claim-headline-wrapper">
              ...
              <div class="claim-headline-right">
                <p>
                  Discover the Subsidy Credit Program, a significant initiative
                  designed to support low-income Americans. This program
                  provides a tax credit that can be used to offset expenses for
                  groceries, rent, gas, and bills. See the impact it's already
                  had:
                </p>
              </div>
            </div>
            <div class="item-container">
              ...
              <div class="claim-item">
                ...
                <div class="smalltext">
                  <p>
                    More families are taking advantage of the tax credits every
                    day.
                  </p>
                </div>
              </div>
              ...
              <div class="claim-item">
                ...
                <div class="smalltext">
                  <p>
                    Act fast to claim your tax credit and improve your financial
                    situation.
                  </p>
                </div>
              </div>
                ...
                <li>
                  <div class="benefit">
                    <div class="benefitHeadline">
                      <h3>Groceries</h3>
                      <p>
                        Use your subsidy credit to reduce your grocery expenses.
                ...
                <li>
                  <div class="benefit">
                    <div class="benefitHeadline">
                      <h3>Rent</h3>
                      <p>
                        Apply your subsidy credit towards your rent. Alleviate
                        the stress of monthly payments.
                      </p>
                    </div>
                    <div class="benefitImage">
                      <img src={rent} alt="" />
                ...
                <li>
                  <div class="benefit">
                    <div class="benefitHeadline">
                      <h3>Bills</h3>
                      <p>
                        Use the subsidy credit to help pay your utility bills.
                        Keep your home comfortable without financial strain
                      </p>
                    </div>
                    <div class="benefitImage">
                      <img src={bill} alt="" />
                ...
                <div class="testimonial-inner">
                  ...
                  <div class="testimonial-bottom">
                    <p>
                      ...
                      Support enough for their prompt assistance. Their team's
                      commitment to me is truly commendable
                    </p>
                    <img
                      src="data:image/png;base64,"
                      alt=""
                ...
                <div class="testimonial-inner">
                  ...
                  <div class="testimonial-bottom">
                    <p>
                      ...
                      rescue. Their team's dedication and service to people are
                      top-notch, and I couldn't be happier with their help.
                    </p>
                    <img
                      src="data:image/png;base64,"
                      alt=""
          ...
          <div class="row">
            <div class="footer-content">
              <p>
                ...
                contract renewal with Medicare. Possible options include, but
                are not limited to Major Medical Plans, Short Term Plans,
                Christian Health Plans, Health Sharing Plans, discount cards and
                Fixed Indemnity Plans.Descriptions are for informational
                purposes only and subject to change. Qualifyaca.com is not
                affiliated with any insurance plan nor does it represent or
                endorse any plan. We do not offer every plan available in your
                area. Any information we provide is limited to those plans we do
                offer in your area. Please contact Medicare.gov or 1–800
                MEDICARE to get information on all of your options. By using
                this site, you acknowledge that you have read and agree to the
                Terms of Service, and Privacy Policy. Not affiliated with the U.
                S. government or federal Medicare program. A licensed agent may
                contact you regarding this insurance-related information.
              </p>
            </div>
          </div>
        </div>
